...
<head>
    ...
    <div class="contain">
    <div id="head">
        <h5 id="add"><span class="add1">COMPLAINT ADDRESSAL PORTAL  ->  </span>HOME | CUSTOMER | RESET PASSWORD<span class="back"><a href="cust1.php" class="link"><u>BACK</u></a></span></h5>
...
if(isset($_POST["submit"])){
    ...
    if($x==0)
    {
        ...
        $password=mysqli_real_escape_string($link,$password);
         $sql="UPDATE customers SET password='$password' where password='$name'";
...
?>
   ...
   <form action="resetcust.php" method="post">
     <br />
